...
function ThemeToggle() {
  ...
  return <div className="theme-toggle"><button type="button" onClick={() => change(nextTheme)} aria-label={`Switch to ${nextTheme} theme`} title={`Switch to ${nextTheme} theme`}><span className="sr-only">Switch to {nextTheme} theme</span>{theme === "light" ? <Moon aria-hidden="true" /> : <Sun aria-hidden="true" />}</button></div>;
}
