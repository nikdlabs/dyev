    ...
    <>
      <section className="hero" aria-labelledby="hero-title">
        ...
        <div className="hero-copy">
          ...
          <Link className="hero-action" href="#work">Enter the work <ArrowDown aria-hidden="true" /></Link>
        </div>
      ...
      <section className="closing"><div className="closing-frame" aria-hidden="true" /><Reveal><p>Ideas do not become things<br />by staying <em>ideas.</em></p><a href="mailto:hello@dyev.in">Say hello <ArrowUpRight aria-hidden="true" /></a></Reveal></section>
    </>
  );
}
